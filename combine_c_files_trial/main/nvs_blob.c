...
void initialize_nvs_data(void)
{
    ...
    uint64_t test_value1 = 0;
    uint64_t test_value2 = 1;
...
//    err = print_blob(gyro_z);
    ...
    err = save_value_nvs(test_value1, lat_init);
    err = save_value_nvs(test_value1, long_init);
    err = save_value_nvs(test_value2, lat_final);
    err = save_value_nvs(test_value2, long_final);
